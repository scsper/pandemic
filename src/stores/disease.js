var Dispatcher = require('../dispatcher/dispatcher.js'),
    _ = require('lodash'),
    bean = require('bean'),
    DiseaseConstants = require('../constants/disease.js'),
    INITIAL_DISEASE_COUNT = 24;

var DiseaseStore = {
    diseases: {
        red: {
            state: DiseaseConstants.INFECTIOUS,
            count: INITIAL_DISEASE_COUNT
        },
